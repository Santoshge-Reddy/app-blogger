...
<head>
    ...
    <title>Dr. Bora Siva Kumar Reddy</title>
    <!-- Font Awesome -->
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.11.2/css/all.css" />
    <!-- Google Fonts Roboto -->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto:wght@300;400;500;700&display=swap" />
    <!-- MDB -->
    <link rel="stylesheet" href="{{ asset('guest/css/mdb.min.css') }}" />
    <!-- Custom styles -->
...
<!--       <nav class="my-4" aria-label="...">
  ...
  <footer class="bg-light text-lg-start">
    ...
    >
      ...
      © 2021 Copyright:
      <a class="text-dark" href="https://mdbootstrap.com/">borasivakumarreddy.com</a>
    </div>
    <!-- Copyright -->
  </footer>
  <!--Footer-->
    <!-- MDB -->
    <script type="text/javascript" src="{{asset('guest/js/mdb.min.js')}}"></script>
    <!-- Custom scripts -->
